...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='iotnexus.conf'
CONFIGFOLDER='/root/.iotnexus'
COIN_DAEMON='iotnexusd'
COIN_CLI='iotnexus-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/IoTNexus/iotnexus/releases/download/v1.1.0.0/iotnexus-1.1.0-linux64.tar.gz'
